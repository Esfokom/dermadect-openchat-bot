...
exports.getSimpleResponse = exports.getHealthJoke = exports.getHealthTip = exports.getRandomItem = void 0;
// Health tips array
const healthTips = [
...
const getHealthTip = () => {
    return (0, exports.getRandomItem)(healthTips);
};
exports.getHealthTip = getHealthTip;
const getHealthJoke = () => {
    return (0, exports.getRandomItem)(healthJokes);
};
exports.getHealthJoke = getHealthJoke;
const getSimpleResponse = (command) => {
